...
class E18_R3(Room.Room):

    def __init__(self):
        super().__init__('Stranger Room', 'https://www.fugacemente.it/roma-colle-prenestino/escape-room/stranger-room/', 'E18_R3')
    ...
    def get_availabilities(self):
        ...
        try:
            ...
            wait.until(
                presence_of_element_located((By.XPATH, '//*[@class="bct-room-col j_tab_content_1 j_room_pk_2"]/span')))
            all_time_elems = driver.find_elements_by_xpath(
                '//*[@class="bct-room-col j_tab_content_1 j_room_pk_2"]/span')
